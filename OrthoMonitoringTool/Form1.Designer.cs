...
namespace OrthoMonitoringTool
{
    partial class Form1
    {
        ...
        /// </summary>
        private void InitializeComponent(bool isStopped)
        {
            ...
            if (!isStopped)
            {
                this.Notify.Icon = ((System.Drawing.Icon)(Resources.Blue));
                Notify.Text = "Ortho started";
            }
            else
            {
                this.Notify.Icon = ((System.Drawing.Icon)(Resources.Red));
